...
from events_manager.report.views import sell_by_event,top_costumers,summerize_event_locality,pareto_costumers
...
urlpatterns = [
    ...
    path('pareto_costumers', pareto_costumers, name='pareto_costumers')
]